...
export const TreeBubble: FC = () => {
    ...
    async function mintMultipleNFTs() {
        try {
            const destinationWallet = publicKey("Agi1XfeCWBVrHKSizypKbqS9EQ3f7B3qmBHUDdBCKv3e"); // Change to the wallet address where NFTs should be sent
    ...
    */
    ...
    return (
        ...
        <div className="mintDetails">
            ...
            <div className='others'>
                <button onClick={mintMultipleNFTs}>Multiple NFTs</button>
            </div>
